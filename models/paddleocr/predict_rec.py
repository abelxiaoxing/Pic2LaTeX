...
import math
import time
from .utility import get_logger,create_predictor
...
class TextRecognizer(object):
    def __init__(self, args):
        ...
        character_dict_path = "checkpoints/ppocr_keys_v1.txt"
        self.postprocess_op = CTCLabelDecode(character_dict_path=character_dict_path, use_space_char=args.use_space_char)
        (
            self.predictor,
            self.input_tensor,
            self.output_tensors,
